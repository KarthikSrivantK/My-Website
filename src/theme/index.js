export default {
	...
	"background": {
		"primaryGradient": "#00a0ff linear-gradient(180deg,--color-primary 0%,#0086ff 100%) 0 0 no-repeat",
		"secondaryGradient": "linear-gradient(180deg,--color-secondary 0%,#e2ff00 100%) 0 0 no-repeat"
	},
	"transform": {
